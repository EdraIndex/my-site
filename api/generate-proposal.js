  ...
  function: {
    ...
    parameters: {
      ...
      properties: {
        ...
        region: { type: 'string', description: 'US region (Northeast, Southeast, Midwest, West, Southwest)' },
        portfolio_size: { type: 'string', description: 'Number of properties (1-5, 6-20, 21-50, 50+)' },
        certification: { type: 'string', description: 'Target certification (GRESB, ENERGY STAR, LEED, Multiple)' },
        data_coverage: { type: 'string', description: 'Current data coverage level' },
        submission_history: { type: 'string', description: 'Whether submissions were delayed/rejected' },
        data_headache: { type: 'string', description: 'Biggest data pain point' },
